...
from tangram2.external.cellphonedb.cpdb.src.core.methods import cpdb_statistical_analysis_complex_method
...
def call(
    ...
    if None in required_arguments or '' in required_arguments or counts_file_path is None:
    ...
    analysis_result['significant_means_result'] = significant_means
