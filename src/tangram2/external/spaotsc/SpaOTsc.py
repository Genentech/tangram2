...
import ot
import dit
from dit.pid.pid import sort_key
...
class spatial_sc(object):
    ...
    def spatial_signaling_ot_singleligand(self,
        Lgene,
        Rgene,
        Tgenes = None,
        Rbgene = None,
    ...
    def spatial_signaling_ot(self,
        ...
        :param Lgenes: name list of the ligand gene
        :type Lgene: list of str
        :param Rgenes: name list of receptor genes
        :type Rgenes: list of str
        :param Tgenes: name list of genes for transporters of ligands
        :type Tgenes: list of str, optional
        :param Rbgenes: name list of genes for proteins bound to receptor for the receptor to work 
        :type Rbgenes: list of str, optional
        :param DSgenes_up: name list of up regulated genes by the ligand-receptor
        :type DSgenes_up: list of str
        :param DSgenes_down: name list of down regulated genes by the ligand-receptor
        :type DSgenes_down: list of str
        :param gene_bandwidth: the cutoffs for each gene to be considered expressed
        :type gene_bandwidth: dictionary (str to scalar), all outputs default to 1
        :param effect_range: spatial distance cutoff for the signaling
        :type effect_range: float
        :param epsilon: weight for entropy regularization term
        :type epsilon: float, defaults to 0.2
        :param rho: weight for KL divergence penalizing unbalanced transport
        :type rho: float, defaults to inf
        :param kernel_nu: the power parameter for the exponential kernel, bigger nu means sharper soft cutoff
        :type kernel_nu: float, defaults to 5
        :param use_kernel_ligand: whether use kernel function to rescale ligand expression
        :type use_kernel_ligand: boolean, defaults to False
        :param use_kernel_receptor: whether use kernel function to rescale receptor expression
        :type use_kernel_receptor: boolean, defaults to False
        :param return_weight_only: whether to only return the weight for source distribution and destination distribution
        :type return_weight_only: boolean, defaults to False
        :return: a scoring matrix for the given signaling genes (cells, cells), (i,j) entry is the score for cell i sending signals to cell j
        :rtype: class:`numpy.ndarray`
        """
    ...
    def visualize_cells(self, type=1, method='umap', perplexity=30.0, umap_n_neighbors=5, umap_min_dist=0.1):
